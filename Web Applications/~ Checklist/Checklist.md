...
### Directory Fuzzing
```shell
ffuf  -w ~/opt/wordlists/web-extensions.txt -u http://10.10.11.128/indexFUZZ

ffuf -w ~/opt/wordlists/directory-list-2.3-medium.txt -u http://10.10.11.128/FUZZ -e .php
```
